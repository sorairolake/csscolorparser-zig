...
test "random colors" {
    ...
    const test_data = [_]struct { []const u8, [4]u8 }{
        ...
        .{ "hsl(157.572grad,22.057%,82.352%,0.748)", .{ 200, 220, 207, 191 } },
        ...
        .{ "hwb(0.083turn 48.957% 19.454% / -0.055)", .{ 205, 165, 125, 0 } },
        .{ "hwb(223.305 46.995% 33.460% / -0.095)", .{ 120, 134, 170, 0 } },
        .{ "hwb(93.679grad 14.835% 5.257%)", .{ 159, 242, 38, 255 } },
        .{ "hwb(208.953grad 43.974% 17.786% / 49%)", .{ 112, 197, 210, 125 } },
        ...
        .{ "hwb(0.953turn 48.769% 4.335% / 0.684)", .{ 244, 124, 158, 174 } },
        ...
        .{ "hwb(0.738turn 12.619% 22.873% / 0.498)", .{ 103, 32, 197, 127 } },
        .{ "hwb(210.399grad 1.847% 38.094%)", .{ 5, 134, 158, 255 } },
        .{ "hwb(143.863 35.042% 31.195% / 0.378)", .{ 89, 175, 124, 96 } },
        .{ "hwb(21.631grad 41.743% 24.160% / 47%)", .{ 193, 135, 106, 120 } },
